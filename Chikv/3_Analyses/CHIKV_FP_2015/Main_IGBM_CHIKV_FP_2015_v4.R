...
stan_file_path  <- paste0(main_path, "2_Stan_files//",   "hierarchical_TSIR_IGBM_v3_chol", ".stan")
store_model_out <- paste0(main_path, "4_Stan_Outputs//", "CHIKV_FP_2014_IGBM_v3_chol", ".RData")
...
#
###########################################################################
bridgeIgbm  <- bridgesampling::bridge_sampler(samples = nuts_fit_1, maxiter = 10000)
