...
store_model_out <- paste0(main_path, "4_Stan_Outputs//", "CHIKV_FWI_2014_IGBM_v5_chol", ".RData")
...
#
###########################################################################
bridgeIgbm <- bridgesampling::bridge_sampler(samples = nuts_fit_1)
...
print(bridgeIgbm)
bridgesampling::error_measures(bridgeIgbm)$re2