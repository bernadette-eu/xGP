...
stan_file_path  <- paste0(main_path, "2_Stan_files//Revision1//", "SEEIIR_renewal_multitype_IGBM_v2B", ".stan")
store_model_out <- paste0(main_path, "4_Stan_Outputs//Revision1//", "SEEIIR_renewal_multitype_IGBM_v3E", ".RData") # 3D where the ifr$AgrIFR <- c(0.07, 0.021, 0.22, 7.2)/100 are considered

#load("C://Users//lbour//OneDrive//Desktop1//xgp_project//GP multitype epidemic England//4_Stan_Outputs//SEEIIR_renewal_multitype_IGBM_v3C.RData")
