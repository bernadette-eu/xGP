...
stan_file_path  <- paste0(main_path, "2_Stan_files//Revision1//", "SEEIIR_renewal_multitype_XGBM_v1C2", ".stan")
store_model_out <- paste0(main_path, "4_Stan_Outputs//Revision1//", "SEEIIR_renewal_multitype_XGBM", ".RData")# 3D where the ifr$AgrIFR <- c(0.07, 0.021, 0.22, 7.2)/100 are considered

load(paste0(main_path, "4_Stan_Outputs//Submission//SEEIIR_renewal_multitype_XGBM_v4E2.RData"))
